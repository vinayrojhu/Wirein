...
import com.example.wirein.ui.theme.components.NumberText
import com.example.wirein.ui.theme.components.TweetActionRow
import com.example.wirein.ui.theme.components.TweetItem
import com.example.wirein.ui.theme.screen.viewmodel.HomeViewModel
import com.example.wirein.util.DateUtil
        ...
        is BaseState.Success -> {
            ...
            if (tweet != null) {
                ...
                Column(
                    ...
                    TopAppBar(
                        title = { Text("Node", fontSize = 18.sp) },
                        navigationIcon = {
